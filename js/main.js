...
// ============================================
// 1. CREAR EDITOR Y DEPENDENCIAS BÁSICAS
// ============================================
...
// ============================================
// 3. ESPERAR A QUE EL DOM ESTÉ LISTO PARA CREAR PANELES CON BOTONES
// ============================================
document.addEventListener("DOMContentLoaded", () => {
  // Crear paneles que dependen de botones en el DOM
  ...
  // No registrar gridConfig porque no tiene botón
  ...
  // ============================================
  // 6. FUNCIÓN UPDATE ACTIVE BUTTON
  // ============================================
  ...
  // ============================================
  // 8. CONFIGURAR EVENTOS DE BOTONES
  // ============================================
  const btnTools2D = document.getElementById("btn-tools-2d");
  if (btnTools2D) {
    btnTools2D.addEventListener("click", () => panelManager.open(tools2DPanel));
  }

  const btnTools3D = document.getElementById("btn-tools-3d");
  if (btnTools3D) {
    btnTools3D.addEventListener("click", () => panelManager.open(tools3DPanel));
  }

  const btnAssets = document.getElementById("btn-assets");
  if (btnAssets) {
    btnAssets.addEventListener("click", () => panelManager.open(assetsPanel));
  }
  ...
  if (btnCamera) {
    btnCamera.addEventListener("click", () => panelManager.open(cameraPanel));
  }
  ...
  // Botón AI Character en el menú
  const btnAI = document.querySelector('[data-action="aiCharacter"]');
  if (btnAI) {
    btnAI.addEventListener("click", () => panelManager.open(aiCharacterPanel));
  }
  ...
  assetsPanel.addAsset(
    ...
    () => {
      ...
      else alert("Selecciona un objeto primero");
    },
  );
  assetsPanel.addAsset(
    "objects-3d",
  ...
  // ============================================
  // 13. EXPONER GLOBALMENTE (opcional)
  // ============================================
